...
export default function BlogIndexPage({ posts }: InferGetStaticPropsType<typeof getStaticProps>) {
  return (
    <Page
      title="EcoSort Blog: Insights on Sustainable Waste Management"
      description="Explore articles, tips, and stories about innovative waste solutions, community impact, and building a greener future with EcoSort."
    >
      <CustomAutofitGrid>
